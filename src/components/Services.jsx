...
const BOOKING_TEMPLATES = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1618401471353-b98aedd07871?auto=format&fit=crop&q=80&w=500',
  ...
  },
  {
    ...
    accentClass: 'bg-pink-505 text-white hover:bg-pink-600 shadow-sm shadow-pink-500/20',
    ...
    cardBg: 'bg-[#150d18] border-pink-955 text-slate-100 shadow-2xl shadow-pink-950/20',
    textColor: 'text-slate-100',
    subTextColor: 'text-slate-400 font-medium',
    headerText: 'text-slate-355',
...
export default function Services() {
  ...
  const [activeIndex, setActiveIndex] = useState(0) // Start with Shopify Setup
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row min-h-full md:min-h-[320px] relative z-10">
                    ...
                    {/* Left/Right Column: Professional's Portrait (hidden on mobile, background instead) */}
                  ...
                  {/* Bottom Image Overlay Label - Mobile only (placed over background absolute) */}
