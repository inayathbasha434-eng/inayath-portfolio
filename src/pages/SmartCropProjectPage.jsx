    ...
    <div className="min-h-screen bg-[#0a0f1e] text-slate-100 selection:bg-emerald-500/30 selection:text-white">
      ...
      <main className="pt-24 lg:pt-32 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Impact Banner */}
          <div className="rounded-3xl bg-gradient-to-br from-emerald-400 to-green-500 p-1 mb-20">
            <div className="bg-[#0d1426]/95 backdrop-blur-xl rounded-[23px] p-8 md:p-12">
              <h2 className="text-xs font-bold text-emerald-400 mb-4 uppercase tracking-widest">The Impact</h2>
          ...
          <div className="flex justify-center">
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-400 to-green-500 text-white font-bold rounded-xl hover:scale-105 active:scale-95 transition-all shadow-[0_0_30px_rgba(16,185,129,0.3)] text-lg"
            >
