  ...
  return (
    <section id="services" ref={sectionRef} className="py-24 bg-[#080d1a] scroll-mt-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        {/* Section Header */}
        <div className="text-center mb-12 fade-in flex flex-col items-center">
              ...
              return (
                ...
                >
                  ...
                  <div className="md:hidden flex flex-col h-[370px] relative overflow-hidden">
                    ...
                    {/* Centered Pill Button directly on background with no glass container */}
                    <div className="relative z-10 px-8 pb-8 flex justify-center w-full">
                      {item.pageRoute ? (
                        <button
