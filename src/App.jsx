  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-slate-100 selection:bg-blue-500/30 selection:text-white">
      ...
      <a
        ...
        className="fixed bottom-4 right-4 md:bottom-5 md:right-5 z-50 flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-green-500 hover:bg-green-400 text-white rounded-full shadow-lg shadow-green-500/40 hover:shadow-green-500/60 transition-all duration-300 hover:-translate-y-1 hover:scale-105 active:scale-95"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 md:w-[26px] md:h-[26px]" viewBox="0 0 24 24" fill="white">
