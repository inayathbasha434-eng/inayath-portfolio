...
export const PROJECTS = [
  ...
  },
  {
    ...
    link: 'https://crop-recommendation-using-ml-theta.vercel.app/',
  ...
  },
  {
    ...
    solution: 'Crafted a high-converting, modern dark-themed web portfolio featuring dynamic 3D-tilt visual cards, custom service badges, and a contact system.',
    outcome: 'Successfully delivered a professional brand identity and high-performance digital presence that elevates client trust and showcases expertise.',
    tagColors: [
      'bg-blue-500/10 text-blue-400 border-blue-500/20',
    ...
    checklist: [
      'Premium interactive dark UI',
      'Service badges & tags integration',
  ...
  return (
    <section id="projects" ref={sectionRef} className="py-16 sm:py-24 bg-[#0a0f1e] scroll-mt-16 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        {/* Section Header */}
        <div className="text-center mb-8 fade-in-section flex flex-col items-center">
                ...
                <div className="relative aspect-[16/10] w-full rounded-t-2xl overflow-hidden bg-[#0a0d14]">
                  {proj.beforeImage && proj.afterImage ? (
                    <div className="relative w-full h-full select-none">
                      <img src={proj.beforeImage} alt="Before AI" width="400" height="250" loading="lazy" decoding="async" className="absolute inset-0 w-full h-full object-cover" />
                      <div className="absolute inset-0 animate-fade-in" style={{ clipPath: `polygon(0 0, ${mobileSliderPositions[index] ?? 50}% 0, ${mobileSliderPositions[index] ?? 50}% 100%, 0 100%)` }}>
                        <img src={proj.afterImage} alt="After AI" width="400" height="250" loading="lazy" decoding="async" className="absolute inset-0 w-full h-full object-cover" />
                      </div>
                    ...
                    <div className="absolute inset-0 w-full h-full">
                      <img src={proj.image} alt={`${proj.title} Preview`} width="400" height="250" loading="lazy" decoding="async" className="block w-full h-full object-cover object-center" />
                    </div>
                  )}
                </div>
